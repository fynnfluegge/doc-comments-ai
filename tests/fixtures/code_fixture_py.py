...
@pytest.fixture
def python_code_fixture_no_doc_comment():
    return """import os
import re
from doc_comments_ai.constants import Language
...
@pytest.fixture
def python_code_fixture_doc_comment():
    return """import os
import re
from doc_comments_ai.constants import Language
...
@pytest.fixture
def python_method_with_no_doc_comment():
    return """def get_programming_language(file_extension: str) -> Language:
    language_mapping = {
        ".py": Language.PYTHON,
        ".js": Language.JAVASCRIPT,
        ".ts": Language.TYPESCRIPT,
...
@pytest.fixture
def python_method_with_doc_comment():
    return """def get_programming_language(file_extension: str) -> Language:
    \"\"\"
    Returns the corresponding programming language based on the given file extension.
